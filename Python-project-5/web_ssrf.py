...
#This code has Server-Side Request Forgery (SSRF) vulnerability vulnerability which comes under owasp top 10 2021
#But bandit deosn't detect this as a vulnerability
app = FastAPI()
